...
export const ROOMS = [
  ...
  { id: 'bengaluru-jayanagar-group', name: 'Bengaluru Jayanagar  Group', branch: true },
  ...
  { id: 'kandivali-west', name: 'Kandivali West', branch: true },
  { id: 'kempscorner', name: 'KempsCorner', branch: true },
  { id: 'lalbaug', name: 'Lalbaug', branch: true },
  { id: 'malad-west', name: 'Malad West', branch: true },
